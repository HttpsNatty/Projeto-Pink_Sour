...
Route::get('/dashboard/{id}', [ReservaController::class, 'show'])->name('reservas.show')->middleware('auth');
Route::get('/dashboard', [ReservaController::class, 'dashboard'])->name('reserva.dashboard')->middleware('auth');
